...
for ep in range(3):
    ...
    for it in range(int(len(X_all)/N)):
        ...
        savemat('/home/users/qli27/Downloads/DDICA-main/HCP_IC5/Latent10.mat',{'latent_x':latent_x.cpu().detach().numpy(), 'latent_x2':latent_x2.cpu().detach().numpy()})
        sigma = 0.1#(N)**(-1/(4+(1)))
        alpha = 1.01#1.01
        ...
        if k%120 == 0:
            ...
            if show_id%2 == 0:            
                ...
                savemat('/home/users/qli27/Downloads/DDICA-main/HCP_IC5/current_results10.mat',{'current_results':save_show})
                savemat('/home/users/qli27/Downloads/DDICA-main/HCP_IC5/current_loss10.mat',{'current_loss':current_loss})
